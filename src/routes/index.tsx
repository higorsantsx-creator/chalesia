...
import { Navbar, Hero, Philosophy, Projects, ProjectCatalog, Process, Details, Investment, BookingForm, Footer, SocialProof, WhatsAppButton } from "@/components/landing";
